   ...
   <section class="row">
	<section class="col s12 m6 push-m3">
		...
		<table class="stripped">
			...
			<tbody>
			<!-- Efetua a listagem dos dados do banco de dados-->
			<?php
			...
			?>
				...
				<tr>
					...
					<!--Botão excluir-->
					<td>
						<a  href="#modal <?php echo $dados['id']; ?>" class="btn-floating waves-effect waves-light modal-trigger red"><i class="material-icons">delete</i></a>
						  <!-- Modal Structure -->
						  ...
						  <div class="modal-content">
						   ...
						   <div class="modal-footer">
						   	<form action="php_action/delete.php"  method="POST">
							     ...
							     <button name="btn-deletar" class="btn red modal-close waves-effect waves-green btn-flat">Sim</button>
